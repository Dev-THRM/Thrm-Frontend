...
export const AdminDashboard = () => {
  ...
  const deleteClient = async (id) => {
    ...
    try {
      const res = await fetch(`http://localhost:5000/api/admin/deleteClients/${id}`, {
        method: "POST",
  ...
  const deleteBlog = async (id) => {
    ...
    try {
      const res = await fetch(`http://localhost:5000/api/admin/deleteBlogs/${id}`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include"
      });
  ...
  const submitClientEdit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `http://localhost:5000/api/admin/edit/editClients/${editingClient._id}`,
        {
          method: "POST",
          credentials: "include",
          body: formData,
  ...
  const submitBlogEdit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `http://localhost:5000/api/admin/edit/editBlogs/${editingBlog._id}`,
        {
          method: "POST",
          credentials: "include",
          body: formData,
